...
-(NSArray*) vdeDemandePhotosAAfficher : (int) index {
//--------------------------------------------------------------------------------------------------------

	// Renvoi un tavleau avec les infos sur la photi et l'image de celle-ci
	
	UIImage * vdePhotoImage				=  [UIImage imageNamed:[self.vdeTableauDesPhotosAAfficher[index-1] vdeNomPhotoSource]];
	VDEPhotoPourAfficher * vdePhotoInfo =  self.vdeTableauDesPhotosAAfficher[index-1];
	
	//return self.vdeTableauDesPhotosAAfficher[index-1];
	
	return @[vdePhotoImage,vdePhotoInfo];
